...
<center>
  ...
  <div style="padding-bottom: 10px; ;">
    <h1 style="font-size: 50px;" class="font-bold">Data Pasien</h1>
  </div>
</center>
        ...
        <tbody>
          ...
          ?>
            <tr>
              ...
              <td>
                <a class="btn" style="background:transparent ; color: black; border: 0; height: min-content;" href="../page/home.php?page=edit_pasien&id=<?= $row['id']; ?>">
                ...
                <a class="btn tbl_hapus" style="background:transparent ; color: red; border: 0; height: min-content;" href="pasien/proses.php?aksi=hapus&id=<?= $row['id']; ?>">
