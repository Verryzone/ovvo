            ...
            <form action="user/proses.php?aksi=tambah" method="post">
                ...
                <div class="px-52 py-10 grid grid-cols-1 w-full">
                    <div class=" form-control w-full ">
                        ...
                        <input type="text" placeholder="" name="nama" class="input input-bordered w-full" />
                    </div>
                    <div class=" form-control w-full ">
                        <label class="label">
                            <span class="label-text">Username</span>
                        </label>
                        <input type="text" placeholder="" name="username" class="input input-bordered w-full" />
                    </div>
                    <div class="form-control w-full">
                        <label class="label">
                            <span class="label-text">Password</span>
                        </label>
                        <input type="Password" placeholder="" name="password" class="input input-bordered w-full" />
                    </div>
                    <div class="form-control w-full">
                        <label class="label">
