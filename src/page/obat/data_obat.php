...
<center>
  ...
  <div style="padding-bottom: 10px; ;">
    <h1 style="font-size: 50px;" class="font-bold">Data Obat</h1>
  </div>
</center>
<div class="md:px-16 px-5">
  <div style="padding-bottom: 10px;">
    <a href="home.php?page=tambah_obat">
      ...
      <table id="myTable" class="table table-compact w-full text-center">
        <thead>
          <tr>
            ...
            <th class="bg-green-200" style="text-align: center;">Kode Obat</th>
          ...
          ?>
            <tr>
              ...
              <td>
                ...
                <a class="btn tbl_hapus" style="background:transparent ; color: red; border: 0; height: min-content;" href="obat/proses.php?aksi=hapus&id=<?= $row['id']; ?>">
