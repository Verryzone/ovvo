<?php
$data = $db->tampil_obat_by_id($_GET['id']);

?>
<center>
    <br>
    <div style="padding-bottom: 10px; ;">
        <h1 style="font-size: 50px;" class="font-bold">Edit Data Obat</h1>
    </div>
</center>
    ...
    <div>
        <div class="shadow-2xl">
            <div class="px-10 py-10">
                <form action="obat/proses.php?aksi=edit&id=<?= $_GET['id']; ?>" method="post">
