<center>
    ...
    <div style="padding-bottom: 10px; ;">
        <h1 style="font-size: 50px;" class="font-bold">Tambah Data Penyakit</h1>
    </div>
</center>
    ...
    <div>
        <div class="shadow-2xl">
            <div class="px-10 py-10">
                <form action="penyakit/proses.php?aksi=tambah" method="post">
                    <div class="gap-0 grid justify-items-center w-full md:grid-cols-2 gap-x-10 grid-cols-1">
                        ...
                        <div class="form-control w-full max-w-xl">
                            ...
                            <input name="biaya" type="text" placeholder="" class="input input-bordered w-full max-w-xl" required />
                        </div>
                    </div>
