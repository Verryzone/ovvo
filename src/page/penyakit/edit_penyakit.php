<?php
$data = $db->tampil_penyakit_by_id($_GET['id']);

?>
<center>
    <br>
    <div style="padding-bottom: 10px; ;">
        <h1 style="font-size: 50px;" class="font-bold">Edit Data Penyakit</h1>
    </div>
</center>
<div class="md:px-16 px-5">
    <div style="padding-bottom: 10px;">
        <a href="../page/home.php?page=data_penyakit">
    ...
    <div>
        <div class="shadow-2xl">
            <div class="px-10 py-10">
                <form action="penyakit/proses.php?aksi=edit&id=<?= $_GET['id']; ?>" method="post">
                    <div class="gap-0 grid justify-items-center w-full md:grid-cols-2 gap-x-10 grid-cols-1">
                        <div class="form-control w-full max-w-xl">
                            <label class="label">
                                <span class="label-text">Nama penyakit</span>
                            </label>
                        ...
                        <div class="form-control w-full max-w-xl">
                            ...
                            <input value="<?= $data['biaya']; ?>" name="biaya" type="text" placeholder="" class="input input-bordered w-full max-w-xl" required />
                        </div>
                    </div>
