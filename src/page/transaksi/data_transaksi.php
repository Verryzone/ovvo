...
<center>
  ...
  <div style="padding-bottom: 10px; ;">
    <h1 style="font-size: 50px;" class="font-bold">Data Transaksi</h1>
  </div>
</center>
<div class="md:px-16 px-5">
  <div style="padding-bottom: 10px;">
    <a href="home.php?page=tambah_transaksi">
      ...
      <table id="myTable" class="table table-compact w-full text-center">
        <thead>
          <tr>
            ...
            <th class="bg-green-200" style="text-align: center;">Kode Transaksi</th>
            ...
            <th class="bg-green-200" style="text-align: center;">Kembalian</th>
            <th class="bg-green-200" style="text-align: center;">Tgl Dibayarkan</th>
            <th class="bg-green-200" style="text-align: center;">Cara Bayar</th>
            <th class="bg-green-200" style="text-align: center;">Status</th>
            <th class="bg-green-200" style="text-align: center;">Action</th>
          </tr>
        </thead>
        <tbody>
          <?php
          $data = $db->tampil_transaksi();
          ...
          ?>
            <tr>
              ...
              <td><?= $status ?></td>
              <td>
                <a class="btn" style="background:transparent ; color: black; border: 0; height: min-content;" href="../page/home.php?page=edit_transaksi&id=<?= $row['id']; ?>">
                ...
                <a class="btn tbl_hapus" style="background:transparent ; color: red; border: 0; height: min-content;" href="transaksi/proses.php?aksi=hapus&id=<?= $row['id']; ?>">
